...
def add_data_for_name(name_data, year, rank, name):
    """
    This function will add names into a dictionary.
    :param name_data: dict, key: a certain name of new born babies, values: dict, he ranks of the name in each year
    :param year: a certain year between 1990-2010
    :param rank: a rank in a certain year
    :param name: a certain name of new born babies
    """
    if name not in name_data:
        ...
        if year in name_data[name]:
            final_rank = min([int(name_data[name][year]), int(rank)])
